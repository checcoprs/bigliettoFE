// CONFIGURAZIONE: Mese 3 = Aprile (Gennaio è 0)
...
startBtn.addEventListener('click', () => {
    ...
    setTimeout(() => {
        ...
        // Piccolo ritardo per permettere al browser di respirare
...
function startAnimation() {
    ...
    // Aspettiamo che il tronco cresca prima di far apparire i cuori
    setTimeout(() => {
        createTreeHearts(35); // 35 cuori sono il compromesso perfetto tra estetica e performance
    }, 1000);
}
    ...
    const interval = setInterval(() => {
        ...
        requestAnimationFrame(() => {
            setTimeout(() => {
                ...
                // Attiva il floating subito dopo l'apparizione
        ...
        creato++;
    }, 80); // Creazione leggermente più veloce ma scaglionata
}
